...
class ASR(sb.Brain):
    def compute_forward(self, batch, stage):
        ...
        hyps = None
        if stage != sb.Stage.TRAIN:
            topk_tokens, topk_lens, _, _ = self.hparams.beam_searcher(x, wav_lens)
...
if __name__ == "__main__":
    ...
    run_on_main(
        ...
        kwargs={
            ...
            "remove_non_speech_event": hparams["remove_non_speech_event"],
            "remove_unintelligible": hparams["remove_unintelligible"],
            "remove_truncated_words": hparams["remove_truncated_words"],
        },
    )
